...
void gui::Container::Pack(VisualElement::Ptr component)
{
...
void gui::Container::HandleEvent(const sf::Event& event)
{
    ...
    {
        if (event.key.scancode == sf::Keyboard::Scancode::W || event.key.scancode == sf::Keyboard::Scancode::Up)
        {
            SelectPrevious();
        }
        else if (event.key.scancode == sf::Keyboard::Scancode::S || event.key.scancode == sf::Keyboard::Scancode::Down)
        {
            SelectNext();
        }
        else if (event.key.scancode == sf::Keyboard::Scancode::Enter || event.key.scancode == sf::Keyboard::Scancode::Space)
        {
            if (HasSelection())
            {
...
void gui::Container::draw(sf::RenderTarget& target, sf::RenderStates states) const
{
    ...
    for (const VisualElement::Ptr& child : m_children)
    {
